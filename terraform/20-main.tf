...
import {
  to = module.VHDataServices.azurerm_servicebus_queue.vh-infra-core-premium["booking"]
  id = "/subscriptions/5ca62022-6aa2-4cee-aaa7-e7536c8d566c/resourceGroups/vh-infra-core-prod/providers/Microsoft.ServiceBus/namespaces/vh-infra-core-prod-premium/queues/booking"
}

import {
  to = module.VHDataServices.azurerm_servicebus_queue.vh-infra-core-premium["video"]
  id = "/subscriptions/5ca62022-6aa2-4cee-aaa7-e7536c8d566c/resourceGroups/vh-infra-core-prod/providers/Microsoft.ServiceBus/namespaces/vh-infra-core-prod-premium/queues/video"
}