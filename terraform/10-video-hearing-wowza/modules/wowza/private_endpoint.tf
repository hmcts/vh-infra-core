...
# BLANKED OUT AS PERMISSION NEEDS GRANTING TO RUN AGAINST SUBSCRTIPTION 4bb049c8-33f3-4860-91b4-9ee45375cc18 before the DNS changes will work
...
#  zone_name           = var.hearings_dns_zone
