...
output "test_api_connection_string" {
  value = "Server=tcp:${azurerm_mssql_server.vh-infra-core.name}.database.windows.net,1433;Initial Catalog=testapi;Persist Security Info=False;User ID=${azurerm_mssql_server.vh-infra-core.administrator_login};Password=${random_password.sqlpass.result};MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;"
}
